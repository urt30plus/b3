...
from b3 import TEAM_BLUE, TEAM_RED, TEAM_SPEC
...
pasub-sub:40           ; set the given client as a substitute for its team
    ...
    def test_match_mode_deactivated(self):
        ...
        self.assertListEqual(
            ["!pasub command is available only in match mode"],
            self.admin.message_history,
        )
    ...
    def test_client_spectator(self):
        ...
        self.admin.says("!sub")
        self.assertListEqual(
            ["Level-40-Admin is a spectator! - Can't set substitute status"],
            self.admin.message_history,
        )
    ...
    def test_client_with_parameters(self):
        ...
        self.assertListEqual(
            ["You were set as substitute for the BLUE team by the Admin"],
            self.moderator.message_history,
        )
