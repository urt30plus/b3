...
class Test_cmd_greeting(Welcome_functional_test):
    ...
    def test_no_parameter(self):
        ...
        self.assertListEqual(
            ["You have no greeting set"], self.superadmin.message_history
        )
        ...
        # THEN
        self.assertListEqual(
            ["Your greeting is hi f00"], self.superadmin.message_history
        )
    ...
    def test_set_new_greeting_nominal(self):
        ...
        # THEN
        self.assertListEqual(
            ["Greeting Test: f00", "Greeting changed to: f00"],
    ...
    def test_set_new_greeting_too_long(self):
        ...
        # THEN
        self.assertListEqual(
            ["Your greeting is too long"], self.superadmin.message_history
        )
        self.assertEqual("f00", self.superadmin.greeting)
    ...
    def test_set_new_greeting_with_placeholder_name(self):
        ...
        # THEN
        self.assertListEqual(
            ["Greeting Test: |SuperAdmin|", "Greeting changed to: |$name|"],
            self.superadmin.message_history,
        )
    ...
    def test_set_new_greeting_with_placeholder_greeting(self):
        ...
        # THEN
        self.assertListEqual(
            ["Greeting Test: |$greeting|", "Greeting changed to: |$greeting|"],
            self.superadmin.message_history,
        )
    ...
    def test_set_new_greeting_with_placeholder_maxLevel(self):
        ...
        # THEN
        self.assertListEqual(
            ["Greeting Test: |100|", "Greeting changed to: |$maxLevel|"],
            self.superadmin.message_history,
        )
    ...
    def test_set_new_greeting_with_placeholder_group(self):
        ...
        # THEN
        self.assertListEqual(
            ["Greeting Test: |Super Admin|", "Greeting changed to: |$group|"],
            self.superadmin.message_history,
        )
    ...
    def test_set_new_greeting_with_placeholder_connections(self):
        ...
        # THEN
        self.assertListEqual(
            ["Greeting Test: |3|", "Greeting changed to: |$connections|"],
            self.superadmin.message_history,
        )
