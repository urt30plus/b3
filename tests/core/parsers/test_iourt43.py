...
class Test_log_lines_parsing(Iourt43TestCase):
    def assertEvent(
        ...
        self.assertIsNotNone(
            event_type_name, "could not find event with name '%s'" % event_type
        )
    ...
    def setUp(self):
        ...
        self.bot = FakeClient(
            self.console, name="BOT", guid="BOT1", team=b3.TEAM_RED, bot=True
        )

    def test_Radio(self):
        self.joe.connects("0")
        self.assertEvent(
            r'''Radio: 0 - 7 - 2 - "New Alley" - "I'm going for the flag"''',
    ...
    def test_Flagcapturetime(self):
        ...
        patate.connects("0")
        self.assertEvent(
            r"""FlagCaptureTime: 0: 1234567890""",
    ...
    def test_Hit_1(self):
        ...
        d4dou.connects("6")
        self.assertEvent(
            r"""Hit: 6 3 5 8: Fat'Matic hit [FR]d4dou in the Torso""",
    ...
    def test_Hit_knife_thrown(self):
        ...
        d4dou.connects("6")
        self.assertEvent(
            r"""Hit: 3 6 9 30: [FR]d4dou hit Fat'Matic in the Legs""",
            event_type="EVT_CLIENT_DAMAGE",
            event_client=d4dou,
            event_target=fatmatic,
            event_data=(20, "13", "9"),
    ...
    def test_Hit_unkown_location(self):
        ...
        with patch.object(self.console, "warning") as warning_mock:
            self.assertEvent(
                r"""Hit: 6 3 321 8: Fat'Matic hit [FR]d4dou in the Pinky""",
                event_type="EVT_CLIENT_DAMAGE",
                event_client=fatmatic,
                event_target=d4dou,
        ...
        self.assertListEqual(
            [
                call(
                    "_getDamagePoints(19, 321) cannot find value : list index out of range"
                )
            ],
    ...
    def test_Kill(self):
        ...
        psyp.connects("1")
        self.assertEvent(
            r"""Kill: 0 1 38: Patate killed psyp by UT_MOD_GLOCK""",
    ...
    def test_Assist(self):
        ...
        striker.connects("2")
        self.assertEvent(
            r"""Assist: 0 1 2: mandolin assisted money to kill striker""",
    ...
    def test_say(self):
        marcel = FakeClient(
            self.console, name="^5Marcel^2[^6CZARMY^2]", guid="11111111111111"
        )
        marcel.connects("6")
        self.assertEvent(
            r"""say: 6 ^5Marcel^2[^6CZARMY^2]: !help""",
    ...
    def test_ClientJumpRunStarted(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientJumpRunStarted: 0 - way: 1""",
    ...
    def test_ClientJumpRunStarted_with_attempt(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientJumpRunStarted: 0 - way: 1 - attempt: 1 of 5""",
            event_type="EVT_CLIENT_JUMP_RUN_START",
            event_client=marcel,
    ...
    def test_ClientJumpRunStopped(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientJumpRunStopped: 0 - way: 1 - time: 12345""",
    ...
    def test_ClientJumpRunStopped_with_attempt(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientJumpRunStopped: 0 - way: 1 - time: 12345 - attempt: 1 of 5""",
            event_type="EVT_CLIENT_JUMP_RUN_STOP",
            event_client=marcel,
            event_data={
                "way_id": "1",
    ...
    def test_ClientJumpRunCancelled(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientJumpRunCanceled: 0 - way: 1""",
    ...
    def test_ClientJumpRunCancelled_with_attempt(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientJumpRunCanceled: 0 - way: 1 - attempt: 1 of 5""",
            event_type="EVT_CLIENT_JUMP_RUN_CANCEL",
            event_client=marcel,
    ...
    def test_ClientSavePosition(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientSavePosition: 0 - 335.384887 - 67.469154 - -23.875000""",
    ...
    def test_ClientLoadPosition(self):
        ...
        marcel.connects("0")
        self.assertEvent(
            r"""ClientLoadPosition: 0 - 335.384887 - 67.469154 - -23.875000""",
    ...
    def test_ClientGoto(self):
        ...
        psyp.connects("1")
        self.assertEvent(
            r"""ClientGoto: 0 - 1 - 335.384887 - 67.469154 - -23.875000""",
    ...
    def test_client_freeze(self):
        ...
        bob.connects("1")
        self.assertEvent(
            r"""Freeze: 0 1 16: Alice froze Bob by UT_MOD_SPAS""",
            event_type="EVT_CLIENT_FREEZE",
            event_client=alice,
            event_target=bob,
            event_data=Iourt43Parser.UT_MOD_SPAS,
        )
    ...
    def test_client_thawout_started(self):
        ...
        bob.connects("1")
        self.assertEvent(
            r"""ThawOutStarted: 0 1: Alice started thawing out Biddle""",
    ...
    def test_client_thawout_finished(self):
        ...
        bob.connects("1")
        self.assertEvent(
            r"""ThawOutFinished: 0 1: Fenix thawed out Biddle""",
    ...
    def test_client_melted(self):
        ...
        alice.connects("0")
        self.assertEvent(
            r"""ClientMelted: 0""", event_type="EVT_CLIENT_MELTED", event_client=alice
        )
    ...
    def test_SurvivorWinner_player(self):
        ...
        self.assertEvent(
            r"""SurvivorWinner: 0""",
            event_type="EVT_CLIENT_SURVIVOR_WINNER",
            event_client=marcel,
        )

    def test_SurvivorWinner_team(self):
        self.assertEvent(
            r"""SurvivorWinner: Red""", event_type="EVT_SURVIVOR_WIN", event_data="Red"
        )
        self.assertEvent(
            r"""SurvivorWinner: Blue""",
            event_type="EVT_SURVIVOR_WIN",
            event_data="Blue",
        )

    def test_bomb_holder_spawn(self):
        self.joe.connects("12")
        self.assertEvent(
            r"""Bombholder is 12""",
            event_type="EVT_CLIENT_ACTION",
            event_data="bomb_holder_spawn",
            event_client=self.joe,
        )
    ...
    def test_bomb_related(self):
        self.joe.connects("2")
        self.assertEvent(
            r"""Bomb was tossed by 2""",
            event_type="EVT_CLIENT_ACTION",
            event_data="bomb_tossed",
            event_client=self.joe,
        )
        self.assertEvent(
            r"""Bomb was planted by 2""",
            event_type="EVT_CLIENT_ACTION",
            event_data="bomb_planted",
            event_client=self.joe,
        )
        self.assertEvent(
            r"""Bomb was defused by 2!""",
            event_type="EVT_CLIENT_ACTION",
            event_data="bomb_defused",
            event_client=self.joe,
        )
        self.assertEvent(
            r"""Bomb has been collected by 2""",
            event_type="EVT_CLIENT_ACTION",
            event_data="bomb_collected",
            event_client=self.joe,
        )
        self.assertEvent(
            r"""Pop!""",
            event_type="EVT_BOMB_EXPLODED",
            event_data=None,
            event_client=None,
        )
    ...
    def test_say_after_player_changed_name(self):
        ...
        assert_new_name_and_text_does_not_break_auth(":joe")
        assert_new_name_and_text_does_not_break_auth(
            "joe", "what does the fox say: Ring-ding-ding-ding-dingeringeding!"
        )
        assert_new_name_and_text_does_not_break_auth(
            "joe:", "what does the fox say: Ring-ding-ding-ding-dingeringeding!"
        )
        assert_new_name_and_text_does_not_break_auth(
            "jo:e", "what does the fox say: Ring-ding-ding-ding-dingeringeding!"
        )
        assert_new_name_and_text_does_not_break_auth(
            "j:oe", "what does the fox say: Ring-ding-ding-ding-dingeringeding!"
        )
        assert_new_name_and_text_does_not_break_auth(
            ":joe", "what does the fox say: Ring-ding-ding-ding-dingeringeding!"
        )
        ...
        assert_new_name_and_text_does_not_break_auth(
            "joe:foo", "what does the fox say: Ring-ding-ding-ding-dingeringeding!"
        )
        assert_new_name_and_text_does_not_break_auth("j:oe", ":")
        assert_new_name_and_text_does_not_break_auth("j:oe", " :")
        assert_new_name_and_text_does_not_break_auth("j:oe", " : ")
...
class Test_kill_mods(Test_log_lines_parsing):
    ...
    def test_mod_water(self):
        self.assertEvent(
            "0:56 Kill: 1022 0 1: <world> killed Joe by MOD_WATER",
    ...
    def test_nuke(self):
        self.assertEvent(
            "5:19 Kill: 0 0 35: Joe killed Joe by UT_MOD_NUKED",
            event_type="EVT_CLIENT_KILL",
    ...
    def test_lava(self):
        self.assertEvent(
            "5:19 Kill: 1022 0 3: <world> killed Joe by MOD_LAVA",
            event_type="EVT_CLIENT_SUICIDE",
            event_client=self.joe,
            event_target=self.joe,
    ...
    def test_falling(self):
        self.assertEvent(
            "0:32 Kill: 1022 0 6: <world> killed Joe by MOD_FALLING",
            event_type="EVT_CLIENT_SUICIDE",
            event_client=self.joe,
            event_target=self.joe,
    ...
    def test_unknown_kill_mode(self):
        self.assertEvent(
            "5:19 Kill: 0 0 1234: Joe killed Joe by MOD_F00",
            event_type="EVT_CLIENT_SUICIDE",
            event_client=self.joe,
            event_target=self.joe,
    ...
    def test_constants(self):
        def assert_mod(kill_mod_number, kill_mod_name):
            self.assertTrue(
                hasattr(self.console, kill_mod_name),
                "expecting parser to have a constant named %s = '%s'"
                % (kill_mod_name, kill_mod_number),
            )
            with patch.object(self.console, "queueEvent") as queueEvent:
                self.console.parseLine(
                    r"""Kill: 0 1 %s: Joe killed Bob by %s"""
                    % (kill_mod_number, kill_mod_name)
                )
                assert queueEvent.called, "No event was fired"
                args = queueEvent.call_args
...
class Test_OnClientuserinfo(Iourt43TestCase):
    ...
    def test_ioclient(self):
        ...
        self.assertEqual(
            self.console.queryClientFrozenSandAccount.call_count, 2
        )  # both on connect and auth
...
class Test_queryClientFrozenSandAccount(Iourt43TestCase):
...
class Test_auth_without_FSA(Iourt43TestCase):
    ...
    def test_unknown_cl_guid(self):
        ...
        self.assertDictEqual(
            {"Kicks": 0, "TempBans": 0, "clients": 0, "Bans": 0, "Warnings": 0},
        ...
        self.assertDictEqual(
            {"Kicks": 0, "TempBans": 0, "clients": 1, "Bans": 0, "Warnings": 0},
            self.console.storage.getCounts(),
        )
...
class Test_auth_with_unknown_FSA(Iourt43TestCase):
    def setUp(self):
        Iourt43TestCase.setUp(self)
...
class Test_auth_with_uniquely_known_FSA(Iourt43TestCase):
    def setUp(self):
        Iourt43TestCase.setUp(self)
        ...
        player = FakeClient(
            console=self.console, name="Joe", guid="cl_guid_A", pbid="joe_fsa"
        )
        player.save()
    ...
    def test_known_cl_guid_for_another_fsa(self):
        ...
        the_other_player = FakeClient(
            console=self.console, name="Jack", guid="cl_guid_X", pbid="jack_fsa"
        )
        ...
        self.assertDictEqual(
            {"Kicks": 0, "TempBans": 0, "clients": 2, "Bans": 0, "Warnings": 0},
            self.console.storage.getCounts(),
        )
        self.assertEqual(0, len(self.console.clients))
...
class Test_auth_with_non_uniquely_known_FSA(Iourt43TestCase):
    def setUp(self):
        Iourt43TestCase.setUp(self)
        # GIVEN a known player with FSA joe_fsa, cl_guid "cl_guid_A" that will connect on slot 3
        when(self.console).write("auth-whois 3").thenReturn(
        ...
        the_other_player = FakeClient(
            console=self.console, name="Jack", guid="cl_guid_B", pbid="joe_fsa"
        )
        the_other_player.save()
        # THEN we have 0 connected players and 2 players known in database
        self.assertDictEqual(
    ...
    def test_unknown_cl_guid(self):
        ...
        self.assertDictEqual(
            {"Kicks": 0, "TempBans": 0, "clients": 3, "Bans": 0, "Warnings": 0},
            self.console.storage.getCounts(),
        )
        ...
        self.assertEqual(
            3, len(self.console.storage.getClientsMatching({"pbid": "joe_fsa"}))
        )
...
class Test_parser_API(Iourt43TestCase):
    def setUp(self):
        Iourt43TestCase.setUp(self)
        self.player = self.console.clients.newClient(
...
"""
    ...
    def test_tempban(self):
        ...
        self.console.write.assert_has_calls(
            [
                call('kick 4 "f00"'),
                call("say theName^7 was temp banned for 1 hour^7 f00"),
            ]
        )
...
class Test_ban_with_FrozenSand_auth(Iourt43TestCase):
    ...
    def mock_authban(
        client,
        response="auth: sending ban for slot %(cid)s : %(pbid)s",
        disconnect=True,
    ):
        def write(cmd):
    ...
    def mock_authban_no_auth(client):
        return Test_ban_with_FrozenSand_auth.mock_authban(
            client, response="Auth services disabled", disconnect=False
        )
...
class Test_newGetByMagic(Iourt43TestCase):
    def setUp(self):
        ...
        self.mike = FakeClient(
            self.console, name="Mike", guid="000000000000000", pbid="wizard"
        )
        self.john = FakeClient(
            self.console, name="John", guid="111111111111111", pbid="miles"
        )
        self.matt = FakeClient(
            self.console, name="Matt", guid="222222222222222", pbid="johndoe"
        )
        self.mark = FakeClient(
            self.console, name="Mark", guid="333333333333333", pbid="markus"
        )
    ...
    def test_get_by_name_and_pbid(self):
        ...
        # THEN
        self.assertListEqual(
            sorted(clients, key=lambda x: x.pbid), [self.matt, self.john]
        )
