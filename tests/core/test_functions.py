...
class TestFuzziGuidMatch(unittest.TestCase):
    def test_1(self):
        self.assertTrue(
            functions.fuzzyGuidMatch('098f6bcd4621d373cade4e832627b4f6', '098f6bcd4621d373cade4e832627b4f6'))
...
class Test_getStuffSoundingLike(unittest.TestCase):
    ...
    def test_exact_match(self):
        ...
        self.assertListEqual(['foO'],
                             functions.getStuffSoundingLike('foO', ['bar', 'foO', 'joe', 'jack', 'averell', 'william']))
    ...
    def test_soundex_match(self):
        self.assertListEqual(['jack'],
                             functions.getStuffSoundingLike('jak', ['bar', 'foO', 'joe', 'jack', 'averell', 'william']))
